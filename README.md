...
Tempo de curso: 23 dias

O objetivo desse projeto era testar as primeiras habilidades aprendidas de JavaScript durante o curso. Nele desenvolvemos algumas funções básicas. As habilidades testadas foram as seguintes:
